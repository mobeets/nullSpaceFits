...
function trials = addExtraFields(trials)
    ...
    trials.thetaActualGrps = io.thetaGroup(trials.thetaActuals, ...
        io.thetaCenters(8));
    trials.thetaActualGrps16 = io.thetaGroup(trials.thetaActuals, ...
        io.thetaCenters(16));
    trials.thetaGrps16 = io.thetaGroup(trials.thetas, ...
        io.thetaCenters(16));
